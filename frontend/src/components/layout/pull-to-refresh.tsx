...
/**
 * ⚠️ ВАЖНО: ТРЕБУЕТСЯ ПРОВЕРКА НА ВСЕХ СТРАНИЦАХ САЙТА
 * 
 * TODO: Перед включением этого компонента необходимо протестировать на ВСЕХ страницах:
 * - Главная страница (/)
 * - Страница входа (/login)
 * - Страница регистрации (/register)
 * - Дашборд (/dashboard)
 * - Страница экзаменов (/exams)
 * - Страница создания экзамена (/exams/create)
 * - Страница прохождения экзамена (/exams/[id])
 ...
 * 
 * Проверить:
 * 1. Работает ли pull-to-refresh корректно на каждой странице
 * 2. Не конфликтует ли с другими жестами (скролл, свайп и т.д.)
 * 3. Корректно ли обновляются данные после refresh
 * 4. Нет ли проблем с производительностью
 * 5. Работает ли на iOS и Android устройствах
 * 
 * Компонент ВРЕМЕННО ОТКЛЮЧЕН в layout.tsx до завершения тестирования.
 */
