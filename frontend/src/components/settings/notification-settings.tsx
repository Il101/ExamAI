        ...
        <Card className="p-6">
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg transition-colors bg-blue-50/30 border-blue-100 hover:bg-blue-50/50 dark:bg-blue-900/20 dark:border-blue-800 dark:hover:bg-blue-900/30">
                        <div className="space-y-0.5">
                            <Label htmlFor="browser-push" className="text-base font-medium flex items-center gap-2">
                                Browser Notifications
                                <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full font-bold uppercase tracking-wider dark:bg-blue-800 dark:text-blue-100">Experimental</span>
                            </Label>
                            <p className="text-sm text-muted-foreground">
