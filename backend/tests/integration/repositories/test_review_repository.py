...
class TestReviewRepository:
    ...
    async def test_list_by_topic(self, test_session):
        ...
        item1 = ReviewItem(user_id=user.id, topic_id=topic1.id, question="Question 1", answer="Answer 1")
        item2 = ReviewItem(user_id=user.id, topic_id=topic1.id, question="Question 2", answer="Answer 2")
        item3 = ReviewItem(user_id=user.id, topic_id=topic2.id, question="Question 3", answer="Answer 3")
    ...
    async def test_count_due_by_user(self, test_session):
        ...
        item1 = ReviewItem(user_id=user.id, topic_id=topic.id, question="Question 1", answer="Answer 1")
        item1.next_review_date = datetime.utcnow() - timedelta(hours=1)
        
        item2 = ReviewItem(user_id=user.id, topic_id=topic.id, question="Question 2", answer="Answer 2")
        item2.next_review_date = datetime.utcnow() - timedelta(hours=2)
        
        item3 = ReviewItem(user_id=user.id, topic_id=topic.id, question="Question 3", answer="Answer 3")
