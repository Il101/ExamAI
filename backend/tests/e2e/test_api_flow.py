...
class TestEndToEndFlow:
    ...
    async def test_full_exam_generation_flow(self, client, test_session):
        """
        ...
        try:
            ...
            # Mock AsyncSessionLocal to use our test_session
            # We need a context manager wrapper that doesn't close the session
            ...
            with patch("app.tasks.exam_tasks.AsyncSessionLocal", return_value=MockSessionContext(test_session)):
