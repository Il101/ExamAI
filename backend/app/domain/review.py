...
class ReviewItem:
    ...
    _w: list[float] = field(
        default_factory=lambda: [
            ...
            0.6,
            2.4,
            5.8,  # Initial stability for ratings 1-4
            4.93,
            0.94,
            0.86,  # Difficulty factors
            0.01,
            1.49,
            0.14,  # Stability increase factors
            0.94,
            2.18,
            0.05,  # Difficulty modifiers
            0.34,
            1.26,
            0.29,  # Advanced stability
            2.61,  # Decay factor
        ]
    )
    ...
    def review(
        self, rating: Rating, review_time: Optional[datetime] = None
    ) -> datetime:
        """
    ...
    def _update_fsrs(self, rating: int):
        ...
        retrievability = self._calculate_retrievability(
            self.stability, self.elapsed_days
        )
