...
class PromptLoader:
    ...
    def load(self, prompt_path: str, **variables) -> str:
        ...
        Args:
            prompt_path: Relative path to prompt file from prompts_dir
                        (e.g., 'planner/course_plan.txt')
            **variables: Template variables to substitute in the prompt
